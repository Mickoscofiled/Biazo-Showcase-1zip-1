      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-7 lg:p-8 border-b border-slate-100 bg-slate-50/50">
                ...
                <a
                  ...
                  className="shrink-0 flex items-center gap-2 bg-[#25D366] hover:bg-[#20c05c] text-white px-5 py-2.5 rounded-full active:scale-95 font-semibold text-sm transition-all hover:scale-105 shadow-md shadow-green-200"
                >
        ...
        >
          ...
          <a
            ...
            className="shrink-0 flex items-center gap-2 bg-white hover:bg-slate-50 text-primary px-7 py-3.5 rounded-full active:scale-95 font-semibold text-sm transition-all hover:scale-105 shadow-lg"
          >
