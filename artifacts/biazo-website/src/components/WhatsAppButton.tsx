      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="w-72 rounded-2xl overflow-hidden shadow-2xl shadow-blue-200/60 border border-blue-100 dark:border-slate-800"
          >
            <div className="bg-[#25D366] px-5 py-4 flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-white dark:bg-slate-900/20 flex items-center justify-center shrink-0">
            ...
            <div className="bg-blue-50 dark:bg-slate-950 px-5 py-5">
              <div className="bg-white dark:bg-slate-900 rounded-xl rounded-tl-none px-4 py-3 max-w-[90%] shadow-sm border border-blue-100 dark:border-slate-800">
            ...
            <div className="bg-white dark:bg-slate-900 px-4 py-4 border-t border-blue-100 dark:border-slate-800">
              <a
                href={WHATSAPP_URL}
                target="_blank"
