...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-white relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(30,144,255,0.07),transparent_70%)]" />
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-6xl relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-primary to-[#66b3ff] bg-clip-text text-transparent">
              Working With You!
            </span>
          </motion.h2>
          <motion.p
