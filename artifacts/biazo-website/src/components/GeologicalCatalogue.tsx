      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-7xl relative z-10">
        ...
        >
          ...
          <motion.a
            ...
            className="group shrink-0 flex items-center gap-2 bg-[#25D366] hover:bg-[#20c05c] text-white px-7 py-3.5 rounded-full active:scale-95 font-semibold transition-all shadow-lg shadow-green-200 hover:shadow-green-300 hover:scale-105"
          >
        ...
        >
          ...
          <a
            ...
            className="shrink-0 flex items-center gap-2 bg-[#25D366] hover:bg-[#20c05c] text-white px-6 py-3 rounded-full active:scale-95 font-semibold text-sm transition-all shadow-md shadow-green-200 hover:scale-105"
          >
