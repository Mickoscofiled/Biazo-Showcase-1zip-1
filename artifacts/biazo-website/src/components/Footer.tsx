          ...
          <motion.div variants={itemVariant} className="md:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="text-xs text-slate-400 hover:text-white transition-colors bg-white px-4 py-2 rounded-full active:scale-95 border border-white/10 hover:border-[#7391D1]/50 hover:bg-[#7391D1]/10 shadow-sm"
              >
