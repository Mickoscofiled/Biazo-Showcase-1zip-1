        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center gap-4 xl:gap-6">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-[#6495ED] hover:bg-[#5282d6] text-white px-5 py-2.5 rounded-full active:scale-95 active:translate-y-0 text-sm font-bold transition-all shadow-lg hover:shadow-xl hover:shadow-[#6495ED]/20 hover:-translate-y-0.5"
            >
